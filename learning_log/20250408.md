...
이상의 사이트에서 margin : 0 auto;로 잡았을 떄 위아래는 그대로인데 좌우 위치가 바뀌었음을 확인할 수 있음
즉 auto의 의미?
...
```
이상의 코드에서 block 요소인 div 태그를 inline-block으로 바꾸게 됐을 때 이전에 배운 margin: 0 auto; 가 먹히지 않는다는 점을 확인할 수 있음
...
git add .
git commit -m "feat: 20250408 positioning"
git push
20250404.md